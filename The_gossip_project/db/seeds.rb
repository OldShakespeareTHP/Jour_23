...
10.times do
  user_temp = User.find_by(id: rand(1..10))
  City.create(name: Faker::Address.city, zip_code: Faker::Address.zip_code)
end

10.times do 
  User.create(first_name: Faker::Name.first_name, last_name: Faker::Name.last_name, description: Faker::Hipster.paragraph(sentence_count: 2), email: Faker::Internet.email, age: rand(14..70), city: City.find_by(id: rand(1..10)))
end

10.times do |id_|
  User.find_by(id: id_).update(city_id)
end

20.times do
  Gossip.create(title: Faker::JapaneseMedia::SwordArtOnline.item, content: Faker::Books::Dune.quote, user: User.find_by(id: rand(1..10)))
end
...
10.times do
  Tag.create(title: hashtag_list[rand(0..len_hashtag_ind_max)])
end
...
(1..20).each do |ind|
  ...
  nb_of_tags = rand(1..3)
  nb_of_tags.times do
    tag_temp = Tag.find_by(id: rand(1..10))
    TagsGossip.create(gossip: gossip_temp, tag: tag_temp)
  end
end
